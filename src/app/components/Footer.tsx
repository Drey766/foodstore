    ...
    <footer className={styles.footer}>
      <div className="container">
        <div className={styles.footerContent}>
          <div className={styles.footerSection}>
            ...
            <p className={styles.description}>
              Subscribe our newsletter for exclusive updates and delicious deals straight to your inbox.
            </p>
          ...
          <div className={styles.footerSection}>
            <h4 className={styles.footerTitle}>Service</h4>
            <ul className={styles.footerLinks}>
              <li><Link href="/about">How it works</Link></li>
              <li><Link href="/menu">Home delivery</Link></li>
              <li><Link href="/menu">Products</Link></li>
        ...
        <div className={styles.footerBottom}>
          <p>&copy; 2025 Bites. All rights reserved.</p>
